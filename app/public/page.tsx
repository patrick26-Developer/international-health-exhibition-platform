...
const homeHeroImages = [
  {
    id: 1,
    src: '/images/accueil/international-health-fair-banner.png',
    alt: { 
  ...
  {
    id: 2,
    src: '/images/accueil/global-health-conference-diverse-audience.png',
    alt: { 
  ...
  {
    id: 3,
    src: '/images/accueil/healthcare-professionals-international-meeting.png',
    alt: { 
  ...
  {
    id: 5,
    src: '/images/accueil/diverse-doctors-team-global-health.png',
    alt: { 
      fr: 'Équipe diversifiée de médecins en santé mondiale', 
      en: 'Diverse team of doctors in global health' 
    },
    title: { 
      fr: 'Collaboration Globale', 
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-20">
          <div className="max-w-6xl mx-auto">
            {/* Logo et en-tête */}
            <div className="mb-12">
              <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-emerald-500/30 backdrop-blur-md border border-emerald-400/50 mb-6">
                <Globe className="h-4 w-4 text-white" />
              ...
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
                ...
                <span className="block text-emerald-300 drop-shadow-2xl mt-4 text-3xl md:text-4xl">
                  {t.hero.subtitle}
                </span>
              </h1>
              
              <p className="text-xl text-white/95 mb-10 max-w-3xl leading-relaxed drop-shadow-lg">
                {t.hero.description}
              </p>
            </div>

            {/* Message fort */}
            <div className="mb-16 p-8 rounded-2xl bg-emerald-500/20 backdrop-blur-md border border-emerald-400/50">
              <div className="flex items-start gap-4">
                <Target className="h-8 w-8 text-emerald-300 flex-shrink-0 mt-1" />
                <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-20">
              <Button size="lg" className="px-8 py-6 text-lg bg-emerald-600 hover:bg-emerald-700 shadow-2xl hover:shadow-emerald-500/50 transition-all duration-300 hover:scale-105">
              ...
              <Button size="lg" variant="outline" className="px-8 py-6 text-lg border-2 dark:border-white border-emerald-600 dark:text-white text-emerald-700 hover:bg-white/20 backdrop-blur-sm shadow-2xl transition-all duration-300 hover:scale-105">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {t.stats.map((stat, idx) => (
                <motion.div
                  ...
                  className="text-center p-6 rounded-xl bg-white/20 backdrop-blur-md border border-white/30"
                >
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <Button size="lg" variant="outline" className="px-8 py-6 text-lg border-2 dark:border-white border-emerald-600 dark:text-white text-emerald-700 hover:bg-white/20 dark:hover:bg-white/20 hover:bg-emerald-50 shadow-2xl transition-all duration-300 hover:scale-105">
              <Link href="/public/programs" className="flex items-center">
